<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" async="true" Inherits="WebApplication1.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <link rel="icon" sizes="128x128" type="image/png" href="http://www.bibliotheca.com/3/images/flags/ca.png" />
<meta charset="utf-8"/>
<title>TITULO DO SEU CHK</title>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-11 col-lg-11 col-xs-11" style="margin-top: 2%;">
                    <center>
                        <h2><div class="neon">
                        TITULO DO SEU CHK</div></h2> <br/>
                    </center>
                    <div class="panel">
                        <div id="2tl" class="panel-heading">
                           TITULO DO SEU CHK

                        </div>
                        <div class="panel-body">
                            <div class="col-xs-8">
                                <textarea name="lista" id="lista" onkeyup="contar_total(this);" style="width:152.4%; border-radius: 10px;" placeholder="xxxxxxxxxxxxxxxx|xx|xxxx|xxxx"  rows="7"></textarea>
                            </div>
 ...
 .neon {
  color: #FFFFFF;
  text-shadow: 0 0 5px #19abff, 0 0 10px #09BDEF, 0 0 20px #09BDEF, 0 0 45px #09BDEF, 0 0 40px #09BDEF;
      }
                                          </style>
                                  <script>
                                      function mudar() {
                                          $("#id").on('change', function(e){
                                          var items = document.getElementById('id').val;
                                          document.getElementById('tl').innerHTML = $(this).val();
                                          document.getElementById('2tl').innerHTML = $(this).val();
                                          return false;
                                          });
                                      }
                                  </script>
        ...
        <script type="text/javascript">
            ...
            <div class="panel-footer">
                <a><Center><o>INDEX DE AUTORIA DO KOBRA | CODADO PELO GIOVANE SILVA EM C# E AJAX | LIVRE DE CAIXA2 | HORARIO: <a id="hora"><a/> </o><Center/></a>
                <div />
                <script>
                    ...
                    function novaData() {
                        var data = new Date();
                        hora.innerHTML = [data.getHours(), data.getMinutes(), data.getSeconds()].map(pad).join(':');
                    }
